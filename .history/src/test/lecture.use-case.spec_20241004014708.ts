...
describe('LectureUseCase', () => {
  ...
  let lectureApplicationRepo: LectureApplicationRepository;
  ...
  beforeEach(async () => {
    ...
    lectureRepo = module.get<LectureRepository>(LectureRepository);
    lectureApplicationRepo = module.get<LectureApplicationRepository>(LectureApplicationRepository);
  });
