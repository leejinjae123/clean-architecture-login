...
describe('LectureUseCase', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        LectureUseCase,
        {
          ...
          useClass: LectureRepository, // 실제 repository의 구현체를 사용
        },
        {
    ...
    lectureRepo = module.get('LectureRepositoryInterface') as jest.Mocked<LectureRepository>;
    lectureApplicationRepo = module.get('LectureApplicationRepositoryInterface') as jest.Mocked<LectureApplicationRepository>;
  });

  it('LectureUseCase가 정의되어 있어야 함', () => {
